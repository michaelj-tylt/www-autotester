          ...
          <div className="flex-shrink-0">
            <div className="space-y-4">
              ...
              <a 
                ...
                className={`block text-${theme.classes.primary} hover:text-${theme.classes.primaryHover} transition-colors`}
              >
                Sidekick
              </a>
              ...
              <a 
                ...
                className={`block text-${theme.classes.secondary} hover:text-${theme.classes.secondaryHover} transition-colors`}
              >
                WebTester
              </a>
            </div>
